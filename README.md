...
**Book Store** is a simple project to display books and its author.
...
- **Load Random Users from the API**
...
```sh
  git clone https://github.com/abiola-arobieke/random-users.git
```
...
Feel free to check the [issues page](https://github.com/abiola-arobieke/random-users.git/issues).
